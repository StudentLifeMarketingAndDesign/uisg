...
.footer-btn{ border-top-width: 3px; border-right-width: 3px; border-bottom-width: 3px; border-left-width: 3px; border-top-style: solid; border-right-style: solid; border-bottom-style: solid; border-left-style: solid; border-top-color: rgb(238, 238, 238); border-right-color: rgb(238, 238, 238); border-bottom-color: rgb(238, 238, 238); border-left-color: rgb(238, 238, 238); color: rgb(255, 255, 255); display: block; margin-top: 12px; padding-top: 5px; padding-right: 5px; padding-bottom: 5px; padding-left: 5px; text-align: center; }
html{ font-size: 15px; }
...
ul.topics-list{ margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; }
ul.topics-list li{ list-style-type: none; padding-top: 8px; padding-right: 0px; padding-bottom: 8px; padding-left: 0px; border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: rgb(238, 238, 238); }
ul.topics-list li:last-child{ border-bottom-style: none; border-bottom-width: initial; border-bottom-color: initial; }
ul.topics-list li:last-child a{ font-weight: bold; }
...
.header{ background-color: rgba(29, 29, 29, 0.546875); }
.logo{ color: white; }
@media screen and (min-width: 768px){
.nav-main li:first-child{ border-left-style: none; border-left-width: initial; border-left-color: initial; }
.nav-main li{ border-right-style: none; border-right-width: initial; border-right-color: initial; }
