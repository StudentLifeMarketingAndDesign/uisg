				    ...
				    <tbody class="table-page table-start">	
					  <% loop Meetings %>
						...
						<td class="documents">
							...
							<% end_if %>
							<% if Legislation1 %>
								<a href="$Legislation1.URL" class="button">Legislation 1 <img src="$Legislation1.Icon" /></a>
							<% end_if %>
							<% if Legislation2 %>
								<a href="$Legislation2.URL" class="button">Legislation 2 <img src="$Legislation2.Icon" /></a>
							<% end_if %>			
						</td>
					</tr>
					<% end_loop %>
